...
counts <- read.csv("C:/Users/Cristopher/Desktop/datos omicos git/covid/analisis omicos/analisis_rna_seq/RawCounts.csv",stringsAsFactors = FALSE)
...
write.csv(toptab, file="C:\\Users\\Cristopher\\Desktop\\datos omicos git\\covid\\analisis omicos\\analisis_rna_seq\\topTable.csv")
...
write.table(ego, file="C:\\Users\\Cristopher\\Desktop\\datos omicos git\\covid\\analisis omicos\\analisis_rna_seq\\Enriquecimiento.csv", dec=".", sep=";")
...
pdf(file="C:\\Users\\Cristopher\\Desktop\\datos omicos git\\covid\\analisis omicos\\analisis_rna_seq\\enrichmentPlots.pdf")
dotplot(ego, showCategory=7)
cnetplot(ego2, showCategory = 3, cex_category =0.3, 
         cex_label_category =0.7, cex_gene=0.2, cex_label_gene=0.4,
         circular=TRUE, colorEdge=TRUE)
